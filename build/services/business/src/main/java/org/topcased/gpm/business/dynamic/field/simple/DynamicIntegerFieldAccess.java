...
/**
 * Access on an integer simple field field
 * 
 * @author tpanuel
 */
public class DynamicIntegerFieldAccess extends
        AbstractDynamicFieldAccess<Integer> {
    ...
    /**
     * Create access on an integer simple field
     * 
     * @param pField
     *            The simple field
     */
    public DynamicIntegerFieldAccess(SimpleField pField) {
    ...
    public Object getFieldValue(Object pDomainContainer, Context pContext) {
        final Integer lDomainValue = getValue(pDomainContainer);
                ...
                if (!DataBaseValuesComparator.equals(lOldValue, lBusinessValue)) {
                    if (StringUtils.isBlank(lBusinessValue)
                        ...
                        setValue(pDomainContainer,
                                Integer.parseInt(lBusinessValue));
                    }
                }
            }
            else {
