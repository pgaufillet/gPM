 ...
 * @author mkargbo
 */
public class RealFieldQueryGenerator extends
        AbstractMultiValuedFieldQueryGenerator {

    /**
     * RealFieldQueryGenerator constructor
     * 
     * @param pUsableFieldData
     *            Usable field to analyze for generation
     */
    public RealFieldQueryGenerator(final UsableFieldData pUsableFieldData) {
