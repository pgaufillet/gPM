...
/**
 * Test <code>$PRODUCT_NAME</code> virtual field on linked fields.
 * 
 * @author nveillet
 */
public class TestLinkedProductNameVirtualField extends
    ...
    static {
        DISPLAY_RESULT.add(Arrays.asList(GpmTestValues.PRODUCT_PRODUCT2, null));
        DISPLAY_RESULT.add(Arrays.asList(GpmTestValues.PRODUCT1_NAME,
                GpmTestValues.PRODUCT_PRODUCT2));

        CRITERION_RESULT.add(Arrays.asList(GpmTestValues.PRODUCT1_NAME,
                GpmTestValues.PRODUCT_PRODUCT2));

        SORT_RESULT.add(Arrays.asList(GpmTestValues.PRODUCT1_NAME,
                GpmTestValues.PRODUCT_PRODUCT2));
        SORT_RESULT.add(Arrays.asList(GpmTestValues.PRODUCT_PRODUCT2, null));

        CRITERION_DISPLAY_SORT_RESULT.add(Arrays.asList(
    ...
    protected String getFieldLabelKey() {
        return VirtualFieldType.$PRODUCT_NAME.getValue();
    }
