 ...
 * @author nsamson
 */
public class TestSetEnvironmentCategoryService extends
    ...
    public void testNormalCase() {
        ...
        CategoryValueData[] lNewCVDs = new CategoryValueData[lLength];
        System.arraycopy(lCVDs, 0, lNewCVDs, 0, lLength - 1);

        lNewCVDs[lLength - 1] = new CategoryValueData(CATEGORY_VALUE);
        lEnvironment.setCategoryValueDatas(lNewCVDs);
        // the old value
        String lOldValue = lCVDs[lLength - 1].getValue();

        // Setting the environment category
        environmentService.setEnvironmentCategory(adminRoleToken, lEnvironment);
    ...
    public void testBadEnvNameCase() {
        ...
        lEnvironment.setLabelKey(CATEGORY_INVALID);
    ...
    public void testBadCatNameCase() {
        ...
        lEnvironment.setCategoryKey(CATEGORY_INVALID);
    ...
    public void testAdminAndPrivateEnvironmentCase() {
        ...
        EnvironmentData lEnvironmentData =
                environmentService.getEnvironmentCategory(adminRoleToken,
                        getProcessName(),
                        GpmTestValues.PRIVATE_ENVIRONMENT_NAME,
    ...
    public void testSetEnvironmentCategoryWithAdminInstanceCase() {
        ...
        EnvironmentData lPublicEnvData =
                environmentService.getEnvironmentCategory(adminRoleToken,
                        getProcessName(), ENVIRONMENT_ENV1,
                        GpmTestValues.CATEGORY_USER_NAME);
        ...
        EnvironmentData lPrivateEnvData =
                environmentService.getEnvironmentCategory(adminRoleToken,
                        getProcessName(),
                        GpmTestValues.PRIVATE_ENVIRONMENT_NAME,
                        GpmTestValues.CATEGORY_USER_NAME);
    ...
    public void testSetEnvironmentCategoryWithProductInstanceCase() {
        ...
        EnvironmentData lPublicEnvData =
                environmentService.getEnvironmentCategory(adminRoleToken,
                        getProcessName(), GpmTestValues.ENVIRONMENT_ENV2,
                        GpmTestValues.CATEGORY_USER_NAME);

        // This environment can be updated
        try {
            environmentService.setEnvironmentCategory(
                    lProductInstanceRoleToken, lPublicEnvData);
        }
        catch (Exception ex) {
            fail("An exception has been thrown.");
        }
