 ...
 */
public class TestGetExtendedActionService extends
    ...
    public void testNormalCase() {
        ...
        assertNotNull("No result found.", lExtendedAction);
        assertEquals("Expected name invalid", NAME, lExtendedAction.getName());
        assertEquals("Expected menu name invalid", MENU_ENTRY,
                lExtendedAction.getMenuEntryName());
        assertEquals("Expected parent menu name invalid", PARENT_MENU_ENTRY,
                lExtendedAction.getMenuEntryParentName());
        assertEquals("Expected extension point name invalid", EXT_POINT,
                lExtendedAction.getExtensionPointName());
