 ...
 */
public class TestDeleteExtendedActionService extends
    ...
    public void testNormalCase() {
        ...
        extensionsService.deleteExtendedAction(adminRoleToken, lExtendedAction);

        lExtendedAction = extensionsService.getExtendedAction(lProcessId, NAME);

        assertNull("Extended Action has not been deleted.", lExtendedAction);
