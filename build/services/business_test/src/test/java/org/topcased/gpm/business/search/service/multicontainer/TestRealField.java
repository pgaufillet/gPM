...
/**
 * Test <code>Real</code> field
 * 
 * @author mkargbo
 */
public class TestRealField extends AbstractFieldTestCase {

    private static final double EXPECTED_CRITERION_VALUE = 2.2;
    ...
    protected ScalarValueData getCriterionValue() {
        return new RealValueData(EXPECTED_CRITERION_VALUE);
    }
