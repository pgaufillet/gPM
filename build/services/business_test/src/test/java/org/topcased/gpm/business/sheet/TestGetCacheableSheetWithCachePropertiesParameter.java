 ...
 * @author mmennad
 */
public class TestGetCacheableSheetWithCachePropertiesParameter extends
    ...
    public void testNormalCase() {
        ...
        assertEquals(lSheetSummary.get(0).getSheetType(),
                lCacheableSheet.getTypeName());
        lSheetSummary.get(0).equals(lCacheableSheet);
