...
/**
 * Test <code>$SHEET_REFERENCE</code> virtual field on linked fields.
 * 
 * @author nveillet
 */
public class TestLinkedSheetReferenceVirtualField extends
    ...
    static {
        DISPLAY_RESULT.add(Arrays.asList("CatB", null));
        DISPLAY_RESULT.add(Arrays.asList("CatA", "SheetType1:8"));

        CRITERION_RESULT.add(Arrays.asList("CatA", "SheetType1:8"));

        SORT_RESULT.add(Arrays.asList("CatA", "SheetType1:8"));
        SORT_RESULT.add(Arrays.asList("CatB", null));

        CRITERION_DISPLAY_SORT_RESULT.add(Arrays.asList("CatA", "SheetType1:8"));
    }
    ...
    protected String getFieldLabelKey() {
        return VirtualFieldType.$SHEET_REFERENCE.getValue();
    }
