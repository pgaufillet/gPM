...
/**
 * Test <code>$SHEET_TYPE</code> virtual field on linked fields.
 * 
 * @author nveillet
 */
public class TestLinkedSheetTypeVirtualField extends
    ...
    static {
        DISPLAY_RESULT.add(Arrays.asList(GpmTestValues.SHEET_TYPE_CAT, null));
        DISPLAY_RESULT.add(Arrays.asList(GpmTestValues.SHEET_TYPE_CAT,
                GpmTestValues.SHEET_TYPE_SHEETTYPE1));

        CRITERION_RESULT.add(Arrays.asList(GpmTestValues.SHEET_TYPE_CAT,
                GpmTestValues.SHEET_TYPE_SHEETTYPE1));

        SORT_RESULT.add(Arrays.asList(GpmTestValues.SHEET_TYPE_CAT, null));
        SORT_RESULT.add(Arrays.asList(GpmTestValues.SHEET_TYPE_CAT,
                GpmTestValues.SHEET_TYPE_SHEETTYPE1));
    ...
    protected String getFieldLabelKey() {
        return VirtualFieldType.$SHEET_TYPE.getValue();
    }
