...
/**
 * Test <code>$SHEET_REFERENCE</code> virtual field.
 * 
 * @author mkargbo
 */
public class TestReferenceVirtualField extends AbstractFieldTestCase {
    ...
    protected String getFieldLabelKey() {
        return VirtualFieldType.$SHEET_REFERENCE.name();
    }
