...
/**
 * TestGetSerializableSheetTypesService
 * 
 * @author mfranche
 */
public class TestGetSerializableSheetTypesService extends
    ...
    public void testNormalCase() {
        ...
        List<SheetType> lSheetTypeList =
                sheetService.getSerializableSheetTypes(adminRoleToken,
                        getProcessName());
