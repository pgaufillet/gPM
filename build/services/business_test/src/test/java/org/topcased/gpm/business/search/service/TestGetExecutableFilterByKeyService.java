...
/**
 * Tests the method <CODE>getExecutableFilterByKey<CODE> of the Search
 * Service.
 * 
 * @author ahaugomm
 */
public class TestGetExecutableFilterByKeyService extends
    ...
    /** the summary suffix */
    private static final String FILTER_DESCR = "my_fiulter_description";
    ...
    public void testNormalCase() {
        ...
        assertNotNull("The executable filter #" + lId
                + " does not exist in the DB.", lNewExecutableFilterData);
        assertTrue("The executable filter #" + lId
