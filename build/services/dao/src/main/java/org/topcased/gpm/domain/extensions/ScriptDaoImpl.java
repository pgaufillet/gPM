...
/**
 * @see org.topcased.gpm.domain.extensions.Script
 * @author nbousquet
 */
public class ScriptDaoImpl
        extends
        org.topcased.gpm.domain.AbstractDao<org.topcased.gpm.domain.extensions.Script, java.lang.String>
        implements org.topcased.gpm.domain.extensions.ScriptDao {

    /**
     * Constructor
     */
    public ScriptDaoImpl() {
        super(org.topcased.gpm.domain.extensions.Script.class);
    }

    /**
     * @see org.topcased.gpm.domain.extensions.Script#getCommand(java.lang.String)
     */
    ...
    public org.topcased.gpm.domain.extensions.Command getCommand(
        ...
        try {
            final java.lang.String lQueryString =
                    "from org.topcased.gpm.domain.extensions.Script as script where script.name = :name";
    ...
    /**
     * @see org.topcased.gpm.domain.extensions.Script#getExtensionPointsWithCommand(java.lang.String)
     */
    ...
    public java.util.List<ExtensionPoint> getExtensionPointsWithCommand(
        ...
        try {
            final java.lang.String lQueryString =
                    "from org.topcased.gpm.domain.extensions.Script as script where script.commandName = :commandName";
            final org.hibernate.Query lQueryObject =
                    super.getSession(false).createQuery(lQueryString);
