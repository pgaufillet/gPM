...
public interface SelectionModel<T> extends HasHandlers, ProvidesKey<T> {
    ...
    public static class SelectionChangeEvent extends
        ...
        /**
         * Fires a selection change event on all registered handlers in the
         * handler manager. If no such handlers exist, this method will do
         * nothing.
         * 
         * @param source
     ...
     *            the data type of records in the list
     */
    public abstract class AbstractSelectionModel<T> implements
            SelectionModel<T> {
        ...
        public HandlerRegistration addSelectionChangeHandler(
            ...
            return handlerManager.addHandler(SelectionChangeEvent.getType(),
                    handler);
        }
        ...
        /**
         * Schedules a {@link SelectionModel.SelectionChangeEvent} to fire at
