...
public interface Cell<C> {
     ...
     * @param viewData
     *            the view data associated with the cell, or null
     * @param event
     ...
     * @param viewData
     *            view data associated with the cell
     * @param sb
     ...
     * cell directly, rather than using {@link Element#setInnerHTML(String)}.
     * See {@link AbstractCell#setValue(Element, Object, Object)} for a default
