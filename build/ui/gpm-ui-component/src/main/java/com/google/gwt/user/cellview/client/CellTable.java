...
public class CellTable<T> extends Widget implements PagingListView<T> {
    ...
    private static class Impl {
        ...
        /**
         * Convert the rowHtml into Elements wrapped by the specifeid table
         * section.
         * 
         * @param sectionTag
        ...
        protected TableSectionElement convertToSectionElement(
            ...
            String innerHtml =
                    "<table><" + sectionTag + ">" + rowHtml + "</" + sectionTag
                            + "></table>";
    ...
    private static class ImplTrident extends Impl {
        ...
        protected TableSectionElement renderSectionContents(
                TableSectionElement section, String html) {
            TableSectionElement newSection =
                    convertToSectionElement(section.getTagName(), html);
    ...
    public CellTable(final int pageSize, Resources resources) {
        ...
        this.impl = new CellListImpl<T>(this, pageSize, tbody) {
            ...
            @Override
            protected void emitHtml(StringBuilder sb, List<T> values,
                ...
                for (int i = start; i < end; i++) {
                    ...
                    boolean isSelected =
                            (selectionModel == null || value == null) ? false
    ...
    public void addColumn(Column<T, ?> col, String headerString,
            String footerString) {
        addColumn(col, new TextHeader(headerString), new TextHeader(
                footerString));
    }
    ...
    public void onBrowserEvent(Event event) {
        ...
        if (section == thead) {
            ...
            column.onBrowserEvent(cell, impl.getPageStart() + row, value,
                    event, providesKey);

            // Update selection.
            if (isSelectionEnabled && event.getTypeInt() == Event.ONCLICK) {
                SelectionModel<? super T> selectionModel =
                        impl.getSelectionModel();
    ...
    private void setLoadingIconVisible(boolean visible) {
        ...
        // Update the colspan.
        TableCellElement td =
                tbodyLoading.getRows().getItem(0).getCells().getItem(0);
