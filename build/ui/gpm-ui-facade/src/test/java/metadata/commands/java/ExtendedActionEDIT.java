 ...
 * @author jlouisy
 */
public class ExtendedActionEDIT implements GDMExtension {
    ...
    public boolean execute(Context pContext) {
        ...
        lSheet.getMultivaluedStringField("EXTENDED_ACTION_FIELD").addLine().set(
                lDate + " : [EXE] EDIT Extended Action");
        ...
        pContext.set(ExtensionsService.RESULT_SHEET_ID, lCacheableSheet.getId());
        return true;
    }
