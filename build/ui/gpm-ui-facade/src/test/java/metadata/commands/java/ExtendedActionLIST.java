 ...
 * @author jlouisy
 */
public class ExtendedActionLIST implements GDMExtension {
    ...
    public boolean execute(Context pContext) {
        ...
        List<String> lSheetIds =
                pContext.get(ExtensionPointParameters.SHEET_IDS);
        ...
        for (String lSheetId : lSheetIds) {
            ...
            lSheet.getMultivaluedStringField("EXTENDED_ACTION_FIELD").addLine().set(
                    lDate + " : [EXE] LIST Extended Action");
        ...
        pContext.set(ExtensionsService.MESSAGE,
                "LIST extended action has been executed");
        return true;
    }
