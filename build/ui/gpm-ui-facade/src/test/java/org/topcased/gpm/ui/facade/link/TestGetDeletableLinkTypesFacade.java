...
/**
 * TestGetDeletableLinkTypesFacade
 * 
 * @author jlouisy
 */
public class TestGetDeletableLinkTypesFacade extends AbstractFacadeTestCase {
    ...
    public void testProductLink() {
        ...
        List<String> lLinkTypesList =
                lLinkFacade.getDeletableLinkTypes(lUiSession,
                        lProduct.getTypeId());
