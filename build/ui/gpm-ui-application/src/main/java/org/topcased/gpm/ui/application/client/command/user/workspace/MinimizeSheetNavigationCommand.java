...
/**
 * A command to minimize the navigation panel.
 * 
 * @author tpanuel
 */
public class MinimizeSheetNavigationCommand extends AbstractCommand implements
        Command {
    /**
     * Create an MinimizeNavigationCommand.
     * 
     * @param pEventBus
     *            The event bus.
     */
    @Inject
    public MinimizeSheetNavigationCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
