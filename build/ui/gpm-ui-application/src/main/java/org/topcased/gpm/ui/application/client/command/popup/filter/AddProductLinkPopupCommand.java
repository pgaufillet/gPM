...
/**
 * A command to add links on a product from the filter popup.
 * 
 * @author nveillet
 */
public class AddProductLinkPopupCommand extends AbstractCommand implements
        ClickHandler {
    /**
     * Create an AddProductLinkPopupCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public AddProductLinkPopupCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
