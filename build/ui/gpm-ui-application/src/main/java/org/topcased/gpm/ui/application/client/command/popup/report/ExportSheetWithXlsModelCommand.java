...
/**
 * A command to launch an export with a specific XLS report model to a single
 * sheet select on the detail view.
 * 
 * @author tpanuel
 */
public class ExportSheetWithXlsModelCommand extends AbstractCommand implements
        ClickHandler {
    /**
     * Create an ExportSheetWithPdfModelCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public ExportSheetWithXlsModelCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
