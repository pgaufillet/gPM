...
/**
 * A command to open sheet link deletion filter on the edition popup.
 * 
 * @author nveillet
 */
public class EditDeleteSheetLinkFilterPopupCommand extends AbstractCommand
        implements ClickHandler {

    /**
     * Create an EditDeleteSheetLinkFilterPopupCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public EditDeleteSheetLinkFilterPopupCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    public void onClick(final ClickEvent pEvent) {
        fireEvent(
                ...
                GlobalEvent.EDIT_SHEET_LINK_DELETION_FILTER.getType(),
