...
/**
 * A command to maximize the detail panel.
 * 
 * @author tpanuel
 */
public class MaximizeSheetDetailCommand extends AbstractCommand implements
        Command {
    /**
     * Create an MaximizeDetailCommand.
     * 
     * @param pEventBus
     *            The event bus.
     */
    @Inject
    public MaximizeSheetDetailCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
