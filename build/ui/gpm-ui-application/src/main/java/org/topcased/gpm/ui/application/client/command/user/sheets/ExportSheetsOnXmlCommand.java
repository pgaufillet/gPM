...
/**
 * A command to export a list of sheets on XML format.
 * 
 * @author tpanuel
 */
public class ExportSheetsOnXmlCommand extends AbstractCommand implements
        Command {
    /**
     * Create an ExportSheetsOnXmlCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public ExportSheetsOnXmlCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
