...
/**
 * A command to launch an export with a specific PDF report model to a single
 * sheet select on the detail view.
 * 
 * @author tpanuel
 */
public class ExportSheetWithPdfModelCommand extends AbstractCommand implements
        ClickHandler {
    /**
     ...
     */
    @Inject
    public ExportSheetWithPdfModelCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
