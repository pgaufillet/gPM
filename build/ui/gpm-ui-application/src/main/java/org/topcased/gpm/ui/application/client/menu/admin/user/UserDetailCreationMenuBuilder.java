...
/**
 * A builder for the menu of the user detail panel.
 * 
 * @author nveillet
 */
public class UserDetailCreationMenuBuilder extends AbstractMenuBuilder {
     ...
     */
    @Inject
    public UserDetailCreationMenuBuilder(final CreateUserCommand pCreateCommand) {
        super();
        registerStandardCommand(ActionName.USER_SAVE, pCreateCommand);
    }
