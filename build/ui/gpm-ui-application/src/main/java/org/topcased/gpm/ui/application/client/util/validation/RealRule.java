...
/**
 * Rule implementation for real (double) field. <h3>Constraint</h3>
 * <p>
 * Value is an double.
 * </p>
 * 
 * @author mkargbo
 */
public class RealRule extends AbstractRule {
    ...
    protected String doCheck(AbstractGpmField<?> pField, String pValue) {
        if (!UIUtils.isDouble(pValue)) {
            return new String(
                    MESSAGES.fieldErrorReal(pField.getTranslatedFieldName()));
        }
        else {
            return null;
        }
