...
/**
 * A command to open sheet link creation filter on the edition popup.
 * 
 * @author nveillet
 */
public class EditCreateSheetLinkFilterPopupCommand extends AbstractCommand
        implements ClickHandler {

    /**
     * Create an EditCreateSheetLinkFilterPopupCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public EditCreateSheetLinkFilterPopupCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    public void onClick(final ClickEvent pEvent) {
        fireEvent(
                ...
                GlobalEvent.EDIT_SHEET_LINK_CREATION_FILTER.getType(),
