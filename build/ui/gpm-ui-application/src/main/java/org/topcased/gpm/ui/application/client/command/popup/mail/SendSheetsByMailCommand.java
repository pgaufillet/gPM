...
/**
 * A command to send by mail the sheets selected on the listing panel.
 * 
 * @author tpanuel
 */
public class SendSheetsByMailCommand extends AbstractCommand implements
        ClickHandler {
    /**
     * Create an SendSheetsByMailCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public SendSheetsByMailCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    public void onClick(final ClickEvent pEvent) {
        ...
        fireEvent(GlobalEvent.SEND_MAIL.getType(), new SendMailAction(
                ...
                getCurrentSheetIds(), lMailForm.getReportModel()),
