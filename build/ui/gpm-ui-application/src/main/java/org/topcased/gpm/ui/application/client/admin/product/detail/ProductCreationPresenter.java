...
/**
 * Presenter for the ProductView on creation mode.
 * 
 * @author tpanuel
 */
public class ProductCreationPresenter extends ProductPresenter {

    /**
     * Create a presenter for the ProductView on creation mode.
     * 
     * @param pDisplay
     ...
     */
    @Inject
    public ProductCreationPresenter(final ProductDisplay pDisplay,
            final EventBus pEventBus,
            final ProductDetailCreationMenuBuilder pMenuBuilder,
