...
/**
 * A command to initialize a sheet from the filter popup.
 * 
 * @author tpanuel
 */
public class InitializeSheetPopupCommand extends AbstractCommand implements
        ClickHandler {
    /**
     ...
     */
    @Inject
    public InitializeSheetPopupCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    public void onClick(final ClickEvent pEvent) {
        ...
        fireEvent(GlobalEvent.LOAD_SHEET.getType(),
                new GetSheetInitializationAction(lProductName,
                        getCurrentSheetId(),
                        lFilterPopupPresenter.getSelectedElementId()),
