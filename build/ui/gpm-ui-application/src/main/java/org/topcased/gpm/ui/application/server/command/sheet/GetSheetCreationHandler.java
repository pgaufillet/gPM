...
/**
 * GetSheetCreationHandler
 * 
 * @author nveillet
 */
public class GetSheetCreationHandler
        extends
        AbstractCommandWithMenuActionHandler<GetSheetCreationAction, GetSheetResult> {

    /**
     * Create the GetSheetCreationHandler
     * 
     * @param pHttpSession
     *            The http session
     */
    @Inject
    public GetSheetCreationHandler(Provider<HttpSession> pHttpSession) {
        super(pHttpSession);
    }
     ...
     */
    @Override
    public GetSheetCreationResult execute(GetSheetCreationAction pAction,
     ...
     */
    @Override
    public Class<GetSheetCreationAction> getActionType() {
        return GetSheetCreationAction.class;
    }
}