...
/**
 * A command to minimize the listing panel.
 * 
 * @author tpanuel
 */
public class MinimizeSheetListingCommand extends AbstractCommand implements
        Command {
    /**
     * Create an MinimizeListingCommand.
     * 
     * @param pEventBus
     *            The event bus.
     */
    @Inject
    public MinimizeSheetListingCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
