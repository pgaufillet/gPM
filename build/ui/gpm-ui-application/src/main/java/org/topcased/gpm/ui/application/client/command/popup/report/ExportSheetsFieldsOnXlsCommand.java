...
/**
 * A command to launch an XLS export with selected to the list of sheets
 * displayed on the listing panel.
 * 
 * @author tpanuel
 */
public class ExportSheetsFieldsOnXlsCommand extends AbstractCommand implements
        ClickHandler {
    /**
     * Create an ExportSheetsFieldsOnXlsCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public ExportSheetsFieldsOnXlsCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
