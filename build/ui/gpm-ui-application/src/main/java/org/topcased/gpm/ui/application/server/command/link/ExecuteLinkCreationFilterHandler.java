...
/**
 * ExecuteLinkCreationFilterHandler
 * 
 * @author nveillet
 */
public class ExecuteLinkCreationFilterHandler
        extends
        AbstractCommandActionHandler<ExecuteLinkCreationFilterAction, AbstractCommandFilterResult> {

    /**
     * Create the ExecuteLinkCreationFilterHandler
     * 
     * @param pHttpSession
     *            The http session
     */
    @Inject
    public ExecuteLinkCreationFilterHandler(Provider<HttpSession> pHttpSession) {
        super(pHttpSession);
    }
    ...
    public AbstractCommandFilterResult execute(
            ExecuteLinkCreationFilterAction pAction, ExecutionContext pContext)
     ...
     */
    @Override
    public Class<ExecuteLinkCreationFilterAction> getActionType() {
        return ExecuteLinkCreationFilterAction.class;
    }
