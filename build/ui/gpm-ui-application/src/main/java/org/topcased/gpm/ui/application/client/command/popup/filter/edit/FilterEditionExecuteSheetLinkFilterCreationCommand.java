 ...
 * @author nveillet
 */
public class FilterEditionExecuteSheetLinkFilterCreationCommand extends
        AbstractFilterEditionExecuteCommand {

    /**
     * Create a FilterEditionExecuteSheetLinkFilterCreationCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public FilterEditionExecuteSheetLinkFilterCreationCommand(EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    protected void executeFilter(UiFilter pFilter) {
        fireEvent(
                GlobalEvent.LINK_SHEET.getType(),
