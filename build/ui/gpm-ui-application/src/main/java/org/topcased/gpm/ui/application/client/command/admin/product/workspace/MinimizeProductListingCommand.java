...
/**
 * A command to minimize the listing panel of the product admin.
 * 
 * @author tpanuel
 */
public class MinimizeProductListingCommand extends AbstractCommand implements
        Command {
    /**
     * Create an MinimizeProductListingCommand.
     * 
     * @param pEventBus
     *            The event bus.
     */
    @Inject
    public MinimizeProductListingCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
