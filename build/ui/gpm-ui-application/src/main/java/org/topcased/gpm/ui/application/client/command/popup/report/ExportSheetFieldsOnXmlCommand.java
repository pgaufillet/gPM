...
/**
 * A command to launch an XML export with selected to the sheet displayed on the
 * detail panel.
 * 
 * @author tpanuel
 */
public class ExportSheetFieldsOnXmlCommand extends AbstractCommand implements
        ClickHandler {
    /**
     * Create an ExportSheetFieldsOnXmlCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public ExportSheetFieldsOnXmlCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
