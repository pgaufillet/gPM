...
/**
 * A command to export a list of sheets on PDF format.
 * 
 * @author tpanuel
 */
public class ExportSheetsOnPdfCommand extends AbstractCommand implements
        Command {
    /**
     * Create an ExportSheetsOnPdfCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public ExportSheetsOnPdfCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
