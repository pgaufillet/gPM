...
/**
 * LoadSheetLinkOnEditionCommand
 * 
 * @author nveillet
 */
public class LoadSheetLinkOnEditionCommand extends AbstractLoadLinkCommand {
     ...
     */
    @Inject
    public LoadSheetLinkOnEditionCommand(EventBus pEventBus) {
        super(pEventBus);
    }
