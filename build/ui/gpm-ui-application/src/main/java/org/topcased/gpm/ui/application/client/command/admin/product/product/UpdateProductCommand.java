...
public class UpdateProductCommand extends AbstractCommand implements Command {
     ...
     */
    @Inject
    public UpdateProductCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    public void execute() {
        ...
        uploadFileAndFireEvent(GlobalEvent.LOAD_PRODUCT.getType(),
                new UpdateProductAction(getCurrentProductId(),
                        lProductPresenter.getProductDescription(),
                        lProductPresenter.getUpdatedFields(),
                        lProductPresenter.getUpdatedLinkFields(),
