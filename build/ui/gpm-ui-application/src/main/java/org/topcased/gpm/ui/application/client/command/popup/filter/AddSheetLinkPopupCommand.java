...
/**
 * A command to add links on a sheet from the filter popup.
 * 
 * @author tpanuel
 */
public class AddSheetLinkPopupCommand extends AbstractCommand implements
        ClickHandler {
    /**
     ...
     */
    @Inject
    public AddSheetLinkPopupCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    public void onClick(final ClickEvent pEvent) {
        ...
        fireEvent(GlobalEvent.LOAD_SHEET.getType(), new CreateSheetLinkAction(
