...
/**
 * A command to open product link creation filter on the edition popup.
 * 
 * @author nveillet
 */
public class EditCreateProductLinkFilterPopupCommand extends AbstractCommand
     ...
     */
    @Inject
    public EditCreateProductLinkFilterPopupCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
