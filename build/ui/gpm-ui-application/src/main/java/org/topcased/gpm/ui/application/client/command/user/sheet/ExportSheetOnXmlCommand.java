...
/**
 * A command to export a sheet on XML format.
 * 
 * @author tpanuel
 */
public class ExportSheetOnXmlCommand extends AbstractCommand implements Command {
    /**
     * Create an ExportSheetOnXmlCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public ExportSheetOnXmlCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
