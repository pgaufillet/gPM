...
/**
 * ExecuteLinkDeletionFilterAction
 * 
 * @author nveillet
 */
public class ExecuteLinkDeletionFilterAction extends
        AbstractCommandExecuteLinkFilterAction {

    /** serialVersionUID */
    private static final long serialVersionUID = 9100888181209683571L;

    /**
     * create action
     */
    public ExecuteLinkDeletionFilterAction() {
    }
     ...
     *            The link type name
     */
    public ExecuteLinkDeletionFilterAction(String pProductName,
