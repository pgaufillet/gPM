...
/**
 * Validate the user creation detail view : validate all the fields.
 * 
 * @author nveillet
 */
public final class UserCreationDetailViewValidator implements ViewValidator {

    private final static UserCreationDetailViewValidator INSTANCE =
            new UserCreationDetailViewValidator();

    /**
     * Private constructor for singleton.
     */
    private UserCreationDetailViewValidator() {
     ...
     */
    public final static UserCreationDetailViewValidator getInstance() {
        return INSTANCE;
    }
    ...
    public String validate(final Action<?> pAction) {
        UserCreationDetailPresenter lCreationDetailPresenter =
