...
/**
 * A command to export a sheet on XLS format.
 * 
 * @author tpanuel
 */
public class ExportSheetOnXlsCommand extends AbstractCommand implements Command {
    /**
     * Create an ExportSheetOnXlsCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public ExportSheetOnXlsCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
