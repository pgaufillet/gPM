...
/**
 * A command to minimize the detail panel.
 * 
 * @author tpanuel
 */
public class MinimizeSheetDetailCommand extends AbstractCommand implements
        Command {
    /**
     * Create an MinimizeDetailCommand.
     * 
     * @param pEventBus
     *            The event bus.
     */
    @Inject
    public MinimizeSheetDetailCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
