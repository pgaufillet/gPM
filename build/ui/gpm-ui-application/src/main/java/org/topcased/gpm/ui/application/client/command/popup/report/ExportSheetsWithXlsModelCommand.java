...
/**
 * A command to launch an export with a specific XLS report model to a list of
 * sheets select on the listing view.
 * 
 * @author tpanuel
 */
public class ExportSheetsWithXlsModelCommand extends AbstractCommand implements
        ClickHandler {
    /**
     ...
     */
    @Inject
    public ExportSheetsWithXlsModelCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
