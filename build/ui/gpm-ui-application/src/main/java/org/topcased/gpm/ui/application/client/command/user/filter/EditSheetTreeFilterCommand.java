 ...
 * @author tpanuel
 */
public class EditSheetTreeFilterCommand extends AbstractCommand implements
        Command, ClickHandler {
    /**
     * Create an EditTreeFilterCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public EditSheetTreeFilterCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
