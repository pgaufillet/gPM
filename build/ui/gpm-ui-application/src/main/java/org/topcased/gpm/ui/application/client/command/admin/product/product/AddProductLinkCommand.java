...
/**
 * A command to add links on a product.
 * 
 * @author tpanuel
 */
public class AddProductLinkCommand extends AbstractCommand implements Command {
    private String linkType;

    /**
     * Create an AddProductLinkCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public AddProductLinkCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    public void execute() {
        ...
        if (isCurrentProductModified()) {
            fireEvent(GlobalEvent.LINK_PRODUCT.getType(),
                    new ExecuteLinkCreationFilterAction(null,
