...
/**
 * A command to edit a tree filter.
 * 
 * @author tpanuel
 */
public class EditProductTreeFilterCommand extends AbstractCommand implements
        Command, ClickHandler {
    /**
     * Create an EditProductTreeFilterCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public EditProductTreeFilterCommand(final EventBus pEventBus) {
        super(pEventBus);
    }
