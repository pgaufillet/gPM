 ...
 * @author nveillet
 */
public class FilterEditionExecuteSheetLinkFilterDeletionCommand extends
        AbstractFilterEditionExecuteCommand {

    /**
     * Create a FilterEditionExecuteSheetLinkFilterDeletionCommand.
     * 
     * @param pEventBus
     *            The bus event.
     */
    @Inject
    public FilterEditionExecuteSheetLinkFilterDeletionCommand(EventBus pEventBus) {
        super(pEventBus);
    }
    ...
    protected void executeFilter(UiFilter pFilter) {
        fireEvent(
                GlobalEvent.UNLINK_SHEET.getType(),
